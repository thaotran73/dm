...
|
*/
require_once(BASEPATH.'application/libraries/constant.inc.php');
require_once(BASEPATH.'application/libraries/getconfig.inc.php');
$config['base_url']	= "http://".WEB_HOST."/";
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
...
|
*/
$config['enable_get_requests'] = TRUE;
